...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Cabeçalho com Painel Retrátil */}
      <div className="fixed top-0 left-0 right-0 z-50 group">
        {/* Título do Grupamento - sempre visível */}
        {grupamentoSelecionado && grupamentos.length > 0 && (
          <div className="bg-red-800 text-white text-center py-3 shadow-lg">
      ...
      <div className="container mx-auto px-4 py-4 space-y-4 pt-20 sm:pt-24 lg:pt-28">
